...
class MyEnsemble(nn.Module):
    def __init__(self,model_1, model_2, model_4):
...
modelB.load_state_dict(torch.load("/Users/eshwarmurthy/Desktop/personal/Msc-LJMU/Pcam_data/model_output/Botnet/checkpoint_best_epoch_num_1_acc_80.5.pth"))
...
model = MyEnsemble(modelA, modelB,modelD)
